        ...
        <div id="chat">
            <?php
                ...
                // Connexion à la base de données
                    ...
                    $reponse = $bdd->prepare("SELECT id_message, Prenom, contenu, to_user_id, from_user_id FROM messages as m JOIN utilisateurs as u ON u.id=m.from_user_id WHERE from_user_id = :id AND to_user_id = '$id_session[0]' OR from_user_id = '$id_session[0]' AND to_user_id = :id ORDER BY id_message DESC LIMIT 0, 50");
